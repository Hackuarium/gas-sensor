...
void setup() 
{
  ...
  byte ABCoff[9] = {0xFF, 0x01, 0x79, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80};
  co2Serial.write(ABCoff, 9); //desactivate automatic calibration every 24h 
}
